...
// RAW-calibrated ADC, pulse irrigation, multi-factor fan, REAL-DAY grow light with 7-day counter + 14h/day window) =====
#include <stdio.h>
#include <string.h>
#include <time.h>
...
/* -------- helper: อยู่ในหน้าต่างเวลาไฟปลูกหรือไม่ -------- */
...
/* ================= Tasks ================= */
// Grow light: REAL-DAY cycle with 7-day counter + 14h/day window (Day 1–3 OFF, Day 4–7 window ON; Day 8+ OFF)
